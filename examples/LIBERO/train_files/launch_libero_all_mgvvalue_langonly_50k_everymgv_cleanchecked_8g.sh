...
export PROJECT_DIR
export CONFIG_YAML="examples/LIBERO/train_files/starvla_cotrain_libero_all_mgvvalue_langonly_goalstartsplit_50k_everymgv.yaml"
...
export STATE_DIR="/mnt/petrelfs/linzhanhui/runs_inspect/starVLA/watch_libero_all_mgvvalue_langonly_50k_everymgv_cleanchecked_8g"
...
export JOB_TAG="libero-all-mgvv50i1"
export JOB_NAME="liball-mgvv50i1-b4-ga2-1n8g"
export RUN_SUFFIX="libero_all_mgvvalue_langonly_goalstartsplit_50k_everymgv_qwen3oft_flash_attention_2_pd4_ga2_1n8g_cleanchecked"
